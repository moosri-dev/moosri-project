                ...
                <form action="#" method="post" id="frmLogin">
                    ...
                    <form class="login100-form validate-form">
                            ...
                            <label class="col-md-4" for="tel">เบอร์โทร</label>
                                <input class="form-control" type="text" name="tel" value="<?= $_SESSION['user_tel']; ?>" placeholder="เบอร์โทร">
                                <span class="focus-input100-1"></span>
                                <span class="focus-input100-2"></span>
                            </div>
                            <div class="wrap-input100 validate-input">
                            <label class="col-md-4" for="email">อีเมล์</label>
                                <input autocomplete="false" class="form-control" type="text" name="email" value="<?= $_SESSION['user_email']; ?>"
                                    placeholder="อีเมล์">
                                <span class="focus-input100-1"></span>
                                <span class="focus-input100-2"></span>
                            </div>
                            ...
                            <label class="col-md-4" for="line">ไลน์</label>
                                <input class="form-control" type="text" name="lineID" value="<?= $_SESSION['user_line']; ?>" placeholder="ไลน์">
                                <span class="focus-input100-1"></span>
                                <span class="focus-input100-2"></span>
                            </div>
                            <div class="wrap-input100 validate-input">
                            <label class="col-md-4" for="status">สถานะ</label>
                                <select class="custom-select" name="status" id="statusid" disabled>
