    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="col-lg-12">
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="myTable">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center" style="width:10%">เวลา/ชม.</th>
                    ...
                    <!-- /.panel -->
                    <a class="btn btn-lg btn-primary" href="pages/massager-management.php"><i class="fa fa-arrow-circle-left" aria-hidden="true"></i>&nbsp&nbsp&nbsp&nbspย้อนกลับ</a>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
